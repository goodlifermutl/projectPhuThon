...
<div class="container">
    ...
    <div class="form-row">
        ...
        <div class="col-md">
            <input type="text" class="form-control" placeholder="เลขบัตร" id="idcard" name="idcard" data-idcard="<?php echo $victim_idcard ?>"  value=""  required>
        </div>
        <div>
